namespace Localizati18n.ResourceGenerator.Tests.SpecialCharacters;
...
public static class SpecialCharactersExpected {
  ...
  public static JsonResourceManager ResourceManager => s_ResourceManager ??= new JsonResourceManager("Localizati18n.Testing.SpecialCharacters", typeof(SpecialCharactersExpected).Assembly, "SpecialCharacters");
