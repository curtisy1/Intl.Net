...
public static class NestedTranslationsExpected {
  ...
  public static JsonResourceManager ResourceManager => s_ResourceManager ??= new JsonResourceManager("Intl.Net.Testing.NestedTranslations", typeof(NestedTranslationsExpected).Assembly, "NestedTranslations");
